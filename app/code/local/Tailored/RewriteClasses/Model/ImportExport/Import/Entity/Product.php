<?php
class Tailored_RewriteClasses_Model_ImportExport_Import_Entity_Product extends Mage_ImportExport_Model_Import_Entity_Product
{
    ...
    protected function _saveProducts()
    {
        ...
        while ($bunch = $this->_dataSourceModel->getNextBunch()) {
            ...
            foreach ($bunch as $rowNum => $rowData) {
                ...
                // Added for allowing Uppercase Latter 
                foreach ($rowData as $index => $value) {
                    unset($rowData[$index]);
                    $rowData[strtolower($index)] = $value;
                }
                ...
                Mage::log($uploadedGalleryFiles,null,'rowData1.log');
