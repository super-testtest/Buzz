<?php
class Tailored_RewriteClasses_Model_Sendfriend_Sendfriend extends Mage_Sendfriend_Model_Sendfriend
{
	/**
     * Recipient Names
     *
    ...
    public function send()
    {
        ...
        $mailTemplate->setReplyToEmail($sender['email']);
        ...
        foreach ($this->getRecipients()->getEmails() as $k => $email) {
            ...
            $mailTemplate->sendTransactional(
                ...
                array(
                    ...
                    'info_name'     => $sender['name'],
                    'info_email'    => $sender['email'],
